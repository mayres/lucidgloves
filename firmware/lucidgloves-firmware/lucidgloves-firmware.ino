...
//serial over Bluetooth
  #define BTSERIAL_DEVICE_NAME "lucid-hall"
...
#define SERVO_SCALING false //dynamic scaling of servo motors
  ...
  #define PINS_MUX_SELECT     12,  /*S0 pin*/ \
                              12,  /*S1 pin*/ \
                              12,  /*S2 pin*/ \
                              12   /*S3 pin (if your mux is 3-bit like 74HC4051 then you can remove this line and the backslash before it.)*/
